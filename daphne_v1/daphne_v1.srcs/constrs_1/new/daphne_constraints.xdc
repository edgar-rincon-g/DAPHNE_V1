...
create_clock -name afe_dclk     -period 2.286       [get_ports afe_dclk_p[2]]
...
set_input_delay -clock afe_dclk -max 0.773          [get_ports afe_p[2][*]];
set_input_delay -clock afe_dclk -min 0.380          [get_ports afe_p[2][*]];
set_input_delay -clock afe_dclk -max 0.773          [get_ports afe_p[2][*]] -clock_fall -add_delay;
set_input_delay -clock afe_dclk -min 0.380          [get_ports afe_p[2][*]] -clock_fall -add_delay;
set_input_delay -clock afe_dclk -max 0.773          [get_ports afe_n[2][*]];
set_input_delay -clock afe_dclk -min 0.380          [get_ports afe_n[2][*]];
set_input_delay -clock afe_dclk -max 0.773          [get_ports afe_n[2][*]] -clock_fall -add_delay;
set_input_delay -clock afe_dclk -min 0.380          [get_ports afe_n[2][*]] -clock_fall -add_delay;
set_input_delay -clock afe_dclk -max 0.773          [get_ports afe_fclk_p[2]];
set_input_delay -clock afe_dclk -min 0.380          [get_ports afe_fclk_p[2]];
set_input_delay -clock afe_dclk -max 0.773          [get_ports afe_fclk_p[2]] -clock_fall -add_delay;
set_input_delay -clock afe_dclk -min 0.380          [get_ports afe_fclk_p[2]] -clock_fall -add_delay;
set_input_delay -clock afe_dclk -max 0.773          [get_ports afe_fclk_n[2]];
set_input_delay -clock afe_dclk -min 0.380          [get_ports afe_fclk_n[2]];
set_input_delay -clock afe_dclk -max 0.773          [get_ports afe_fclk_n[2]] -clock_fall -add_delay; 
set_input_delay -clock afe_dclk -min 0.380          [get_ports afe_fclk_n[2]] -clock_fall -add_delay;

# False Paths related to Input Delay definition
set_false_path -from                                [get_ports afe_fclk_p[2]]
set_false_path -from                                [get_ports afe_fclk_n[2]]
set_false_path -from                                [get_ports afe_p[2][*]]
set_false_path -from                                [get_ports afe_n[2][*]]
