...
#-----------------------------------------------------------
  ...
  create_clock  -period 16.000 [get_pins -of [get_cells -hierarchical -filter {NAME =~ *pcs_pma_block_i/transceiver_inst/gtwizard_inst/*/gtwizard_i/gt0_GTWIZARD_i/gtpe2_i}] -filter {REF_PIN_NAME =~ TXOUTCLK}]
  ...
  create_clock  -period 16.000 [get_pins -of [get_cells -hierarchical -filter {NAME =~ *pcs_pma_block_i/transceiver_inst/gtwizard_inst/*/gtwizard_i/gt0_GTWIZARD_i/gtpe2_i}] -filter {REF_PIN_NAME =~ RXOUTCLK}]
