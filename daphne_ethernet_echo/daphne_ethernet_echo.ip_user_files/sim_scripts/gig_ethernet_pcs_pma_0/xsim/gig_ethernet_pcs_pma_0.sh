...
#
# Script generated by Vivado on Tue Oct 31 10:52:20 -0500 2023
...
# script info
echo -e "gig_ethernet_pcs_pma_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L gig_ethernet_pcs_pma_v16_2_12 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot gig_ethernet_pcs_pma_0 xil_defaultlib.gig_ethernet_pcs_pma_0 xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="F:/AMDXilinx/Vivado/2023.1/data/xsim"
  fi
